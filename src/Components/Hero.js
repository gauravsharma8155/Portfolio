  ...
  return (
   ...
   <div class="home-hero__socials">
      <div class="home-hero__social">
        <a href="https://www.linkedin.com/in/gaurav-sharma-4bba8621a/s" class="home-hero__social-icon-link" rel="noreferrer" target="_blank">
      ...
      <div class="home-hero__social">
        <a href="https://github.com/gauravsharma8155" class="home-hero__social-icon-link" rel="noreferrer" target="_blank">
      ...
      <div className="hero-container">
        <div className='Name_container'>
          <div className='main_name_container'>
            <div className='nameing_container'>
              <div className='center_container'>
                <div className='gaurav'>  GAURAV</div>
                <div className='img_container'>
                  <img src={profile} alt='profile' className='profile_picture' />
                </div>
                <div className='sharma'>
                  SHARMA,
                </div>
              </div>
            </div>
            ...
            <div className='nameing_container'>
              ...
              <div className='box_22'>
                <img src={Rectangle} alt='Rectangle' className='rectangle_picture' />
              </div>
            ...
            <div className='nameing_container'>
              <div className='center_container_2'>
                {/* <div>fROM <span className='jaipur'>Jaipur</span></div> */}
                <div className='form_box_1'>
                  <div className='btn_divvv'>
                    <div className='view_all'>
                    <a href="./#projects" className="btn_view">VIEW ALL WORK </a>
                      {/* <button className='btn_view'>VIEW ALL WORK</button> */}
                    </div>
                    <hr></hr>
                    <div className='get_in'>
            <a href="./#contact" className="btn_in"> GET IN TOUCH </a>

                      {/* <button className='btn_in'>GET IN TOUCH</button> */}
                    </div>
                  </div>
